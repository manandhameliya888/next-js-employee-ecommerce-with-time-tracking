...
// //     <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-3xl-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-3xl-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600" />
...
//   return (
//     <>
//       <label className='themeSwitcherTwo shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-3xl-md bg-white p-1'>
//         <input
//           type='checkbox'
//           className='sr-only'
//           checked={isChecked}
...
//           className={`${
//             activeTab === tab.id ? "" : "hover:text-white/60 hover:bg-violet-200"
//           } relative rounded-full px-3 py-1.5 text-sm font-medium text-black bg-white outline-sky-400 transition focus-visible:outline-2`}
//           style={{
...
//           onClick={() => setActiveTab(tab.id)}
//           className={`${
//             activeTab === tab.id ? "" : "bg-gray-200 text-blue-600 hover:text-white hover:bg-violet-300"
...
//             <motion.span
//               layoutId="bubble"
//               className="absolute inset-0 z-10 bg-transparent text-yellow-400 mix-blend-difference"
//               style={{ borderRadius: 9999 }}
//               transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
//             />
//           )}
...
//       <div className="relative flex p-1 w-100 bg-gray-800 rounded-full">
//         {/* Active Tab Indicator */}
//         <div
//           className="absolute px-12 py-2 h-10 bg-purple-600 rounded-full transition-all duration-300"
//           style={{ transform: `translateX(${activeTab * 100}%)` }}
//         ></div>

//         {/* Tabs */}
//         {["Clock Out", "Clock In"].map((tab, index) => (
//           <button
//             key={index}
//             className="relative w-26 px-3 pr-4 py-2 text-white font-medium rounded-full z-10 focus:outline-none"
...
const TabSwitcher = () => {
  ...
  return (
    ...
    {/* <div className="flex justify-center items-center min-h-screen bg-gray-900"> */}
      <div className="relative flex bg-white shadow-lg rounded-full p-1 w-[203.5px] h-[40px]">
        {/* Active Indicator */}
        <div
          className="absolute h-[32px] w-[98px] bg-purple-600 rounded-full transition-all duration-300"
          style={{ transform: `translateX(${activeTab * 100}%)` }}
        ></div>
        ...
        {["Clock Out", "Clock In"].map((tab, index) => (
          <button
            key={index}
            className={`relative w-[98px] h-[32px] flex items-center justify-center text-white font-medium rounded-full z-10`}
            onClick={() => setActiveTab(index)}
          >
            {tab}
          </button>
